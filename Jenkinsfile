node {
   ...
   stage('Run NeoLoad - scenario2') {
        dir ('NeoLoad') {
        //NeoLoad Test
        neoloadRun executable: '/opt/Neoload6.6/bin/NeoLoadCmd -nlweb -nlwebAPIURL http://192.168.3.70:8080 -nlwebToken GUr8tmvz3Frm9rH2DRnvYL4L  ', project: '/home/dynatrace/NeoLoadProjects/DemoProject/DemoProject.nlp', scenario: 'scenario2', trendGraphs: ['AvgResponseTime', 'ErrorRate']     
        }
    } 
